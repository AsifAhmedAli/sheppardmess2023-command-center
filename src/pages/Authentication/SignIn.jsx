...
const SignIn = () => {
  return (
    ...
    <div className="absolute -top-[19px] left-0 w-[231px] h-[392px] bg-[url(/loginbgleft.png)] bg-no-repeat bg-contain opacity-60"></div>
      ...
      {/* right */}
      <div className='w-[772px] h-[872px] bg-[#666666] bg-opacity-20 rounded-3xl p-5 mt-10 border border-graydark shadow-lg'>
            {/* <span className='mb-1.5 block font-medium'>Start for free</span> */}
              <Link className='mt-5 ml-5 inline-block' to='/'>
           ...
           <form>
              <div className='flex flex-col items-center'>
                <div className='mb-5 flex flex-col'>
                  ...
                  <input className='w-[420px] border border-[#DED2D9] bg-transparent py-[13px] px-[10px] rounded-[5px]' type="email" name="" placeholder='mail@abc.com' id="" />
                </div>
                <div className='mb-5 flex flex-col'>
                  <label htmlFor="" className='text-[#828282] text-[14px] leading-[19.1px] font-semibold py-1'>Password</label>
                
                  <input className='w-[420px] border border-[#DED2D9] bg-transparent py-[13px] px-[10px] rounded-[5px]' type="email" name="" placeholder='*****************' id="" />
                </div>
              </div>
              <div className='w-[420px] mx-auto flex justify-between'>
