...
//   return (
//     <>
//         <div className='w-[367px] h-[660px] rounded-xl bg-[#13141B]'>
//         <h1 className='text-[20px] leading-6 font-normal text-[#FFFFFF] p-5'>Software Security Supply Chain</h1>
//         <div className='flex flex-col text-[18px] leading-6 font-normal text-[#FFFFFF]'>
//         <div className='flex items-center justify-evenly'>
//             <AiOutlineSafety className='w-[34px] h-[34px] text-[#FFFFFF]' />
//             <h1>Runtime projection & Monitoring</h1>
//         </div>
//         <div className='w-[1px] h-85] bg-[#464665]  my-1'></div>
//         <div className='flex items-center justify-evenly'>
//             <AiOutlineSafety className='w-[34px] h-[34px] text-[#FFFFFF]' />
//             <h1>Security Verification & testing</h1>
//         </div>
//         <div className='w-[1px] h-[91px] bg-[#464665]  my-1'></div>
//         <div className='flex items-center justify-evenly'>
//             <AiOutlineSafety className='w-[34px] h-[34px] text-[#FFFFFF]' />
...
const SoftwareSecuritySupply = () => {
  return (
    <>
        ...
        <div className='flex flex-col text-[18px] leading-6 font-normal text-[#FFFFFF]'>
        <div className='flex items-center justify-evenly'>
            <img src="/icons/shield.png" alt="shield Icon" className='w-[34px] h-[34px] text-[#FFFFFF]' />
            <h1 style={{flexGrow: 1}} className=' ml-8'>Runtime projection & Monitoring</h1>
        </div>
        <div className='w-[1px] h-21 bg-[#464665] ml-4 mb-1'></div>
        <div className='flex items-center justify-evenly'>
        ...
        <div className='w-[1px] h-21 bg-[#464665] ml-4 mt-2'></div>
        <div className='flex items-center justify-evenly'>
        ...
        <div className='w-[1px] h-21 bg-[#464665] ml-4 my-1'></div>
        <div className='flex items-center justify-evenly'>
